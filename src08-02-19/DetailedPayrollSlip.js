  ...
  render() {
    return (
      <div className="container">
        ...
        <h3 className="centerAlign" style={{ marginTop: "-13px", textAlign: "center" }}>PayRoll Management</h3>
        <div id='horMenu'>
          <ul id='horMenunew' style={{ backgroundColor: "#8811d6" }}>
            <li><a className="active" onClick={() => this.OrganizationPaySlip()}><span class="glyphicon glyphicon-plus">Organization PaySlip</span></a></li>
            <li><a onClick={() => this.DetailedPaySlip()}><span class="glyphicon glyphicon-minus">Detailed Organization PaySlip</span> </a></li>
          </ul>
        </div>
