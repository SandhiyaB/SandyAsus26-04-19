...
class DepartmentPage extends Component {
    ...
    GetData() {
        ...
        $.each(Department, function (i, item) {
            ...
            department += '<tbody id= "myTable" ><tr class="success"><td>' + num + '</td><td>' + item.department + '</td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody >';
            num = num + 1;
            lastnum = num;
        });
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (data.authorization == "DUPLICATE") {
                        ...
                        $("#departmentTable").append('<tbody id= "myTable" ><tr class="success"><td>' + lastnum + '</td><td>' + self.state.department + '</td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody>');
