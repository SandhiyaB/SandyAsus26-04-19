       ...
       console.log(data);
        ...
        if (data.length != 0) {
          ...
          $.each(data, function (i, item) {
            ...
            tab += '<tbody id= "myTable"><tr ><td>' + item.employeeId + '</td><td>' + item.subjectName + '</td><td>' + item.description+ '</td><td>'+item.date+'</td><td>'+item.completionDate+'</td><td>'+item.submittedDate+'</td><td>'+Status+'</td></tr></tbody>';
           });
