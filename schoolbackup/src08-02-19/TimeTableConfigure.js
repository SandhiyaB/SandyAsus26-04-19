 ...
 */}
        ...
        <div id='horMenu'>
          <ul  id='horMenunew'>
            <li><a  className="active" onClick={() => this.TimeFunc()}><span class="glyphicon glyphicon-calendar">Time </span></a></li>
            <li><a style={{wordSpacing: "-11px"}} onClick={() => this.DataProlongDetailsFunc()}><span class="glyphicon glyphicon-calendar">Data Prolong Details</span></a></li>
          </ul>
