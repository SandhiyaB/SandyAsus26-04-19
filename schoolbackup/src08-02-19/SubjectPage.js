...
class SubjectPage extends Component {
  ...
  GetData() {
    ...
    $.each(Subject, function (i, item) {
      ...
      subject += '<tbody id= "myTable" ><tr class="success"><td>' + num + '</td><td>' + item.subject + '</td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody >';
      num = num + 1;
      lastnum = num;
    });
      ...
      $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
          if (data.authorization == "DUPLICATE") {
            ...
            $("#subjectTable").append('<tbody id= "myTable" ><tr class="success"><td>' + lastnum + '</td><td>' + self.state.subject + '</td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody>');
