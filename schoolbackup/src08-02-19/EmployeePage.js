        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $.each(data, function (i, item) {
                    ...
                    emp += '<tbody id= "myTable" ><tr class="success"><td>' + item.employeeId + '</td><td>' + item.employeeName + '</td><td>' + item.role + '</td><td>' + item.department + '</td><td ><button id="update">' + "Update" + '</button></td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody >';
                    num = num + 1;
                    lastnum = num;
                    }
                });
        ...
        ReactDOM.render(
		    <Router>
				<div>
					...
					<Route path="/" component={AddStudentStaffPage} />
					...
					ReactDOM.render(
						<Router >
							<div>
								<Route path="/" component={EmployeeMenuHeader} />
								<Route path="/" component={SchoolMaintenance} />
								<Route path="/" component={() => <EditStudentStaffPage data={data} />} />
								<Route path="/" component={FooterText} />
