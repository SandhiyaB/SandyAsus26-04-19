...
class EditDataTableTime extends Component {
  ...
  componentDidMount() {
    ...
    var desireFeature;
    desireFeature += '<optionvalue=""  disabled selected hidden >Select a Value</option>'
    ...
    return (
      <div className="container">
       ...
       {/*  <div id='horMenu'>
        ...
        <div id='horMenu'>
          <ul  id='horMenunew'>
            <li><a style={{ fontSize: "medium", fontStyle: "bold" }} className="active" onClick={() => this.EditTime()}><span class="glyphicon glyphicon-calendar">Edit Time </span></a></li>
            <li><a style={{ fontSize: "medium", fontStyle: "bold" }} onClick={() => this.EditData()}><span class="glyphicon glyphicon-calendar">Edit Data</span></a></li>
            <li><a style={{ fontSize: "medium", fontStyle: "bold" }} className="active" onClick={() => this.AddNewPeriod()}><span class="glyphicon glyphicon-calendar">Add New Period</span></a></li>
