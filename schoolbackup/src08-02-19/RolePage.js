...
class RolePage extends Component {
  ...
  GetData() {
    ...
    $.each(Role, function (i, item) {
      ...
      role += '<tbody id= "myTable" ><tr class="success"><td>' + num + '</td><td>' + item.role + '</td><td ><button id="update">' + "Update" + '</button></td><td ><button id="delete">' + "Delete" + '</button></td></tr></tbody >';
      num = num + 1;
      lastnum = num;
    });
      ...
      $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
          if (data.authorization == "DUPLICATE") {
            ...
            $("#roleTable").append('<tbody id= "myTable" ><tr class="success"><td>' + lastnum + '</td><td>' + self.state.role + '</td><td ><button id="update">' + "Update" + '</button></td><td><button id="delete">' + "Delete" + '</button></td></tr></tbody>');
            confirmAlert({
