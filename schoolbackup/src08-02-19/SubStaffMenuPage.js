 ...
 */}
				...
				<div id='horMenu'>
					<ul id='horMenunew' >
						<li><a className="active" onClick={() => this.AssignFunc()}><span class="glyphicon glyphicon-user">Assign </span></a></li>
						<li><a onClick={() => this.UpdateFunc()}><span class="glyphicon glyphicon-th-large">Update</span></a></li>
					</ul>
