 ...
 */
 ...
 tab += '<tr class="trdata" style={{ marginTop: "0px", textAlign: "center" }} ><td class="payslipdata"><input data-original-title="' + empBasicData + '" data-container="body" data-toggle="tooltip" data-placement="bottom" title="" type="text" name="employeeid" id="employeeid" class="employeeid jeeva" '
 + 'value="' + empBasicData + '" style=" width:270px; margin-top:0px;margin-bottom:0px; line-height: 1em;height: 3em;overflow: hidden; " data-target="#employeeId" data-toggle="tooltip" data-placement=top title=empBasicData readonly></input></td>'
 ...
 */
 ...
 + '<td class="payslipdata"><input style=" width:70px" type="text" name="netsalary" id="netsalary" class="netsalary jeeva" '
 ...
 + 'value="' + additionAmount1[i] + '" ></input></td>'
 ...
 + 'value="' + reductionAmount[i] + '"></input></td>'
 ...
 + 'value="' + empBasicData + '" style=" width:270px; margin-top:0px;margin-bottom:0px; line-height: 1em;height: 3em;overflow: hidden; " readonly></input></td>'
 ...
 */
 ...
 <table id="salaryTable" name="salaryTable" style={{ marginTop: "50px", textAlign: "center" }}>
 <thead 
 style={{ backgroundColor:" #95abbf",
 color: "white"}}>
 ...
 <th class="verticalTableHeader BasicPay" >
 Basic Pay
 </th>
 <th class="verticalTableHeader">
 Net Salary
